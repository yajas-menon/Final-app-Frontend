      ...
      <div className="flex flex-col min-h-screen">
        <main className="flex-1 p-4 flex flex-col gap-4">
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <div className="flex flex-col md:flex-row  gap-4">
                ...
                <button
                  className="ml-auto md:ml-auto h-8 w-8 border border-gray-300 rounded-full flex items-center justify-center"
                  title="View more"
                >
          ...
          <Card>
            ...
            <p className="text-sm">
              Number of assessments conducted over the past 6 months
            </p>
            <BarGraph
...
function CurvedlineChart(props) {
  return <div {...props}>{/* Chart Implementation */}</div>;
}
