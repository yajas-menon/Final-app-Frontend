            ...
            <div class="flex justify-between items-center">
              <div class="flex w-20 max-w-lg ml-10">
                <input
                  ...
                  class="border max-w-md border-gray-300 rounded p-2 focus:outline-none flex-grow"
                />
                <select
                  name=""
                  id=""
                  class="border border-gray-300 max-w-md rounded p-2 focus:outline-none ml-4"
                >
                  <option class="" value="">
                    Sort
                  </option>
